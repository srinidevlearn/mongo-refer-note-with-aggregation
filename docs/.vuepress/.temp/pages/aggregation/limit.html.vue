<template><div><p>$limit</p>
<ul>
<li>
<p>Limits the number of documents passed to the next stage in the pipeline.</p>
</li>
<li>
<p>takes a positive integer that specifies the maximum number of documents to pass along.</p>
</li>
</ul>
<p>$skip</p>
<ul>
...
<li>
<p>takes a positive integer that specifies the maximum number of documents to skip.</p>
</li>
</ul>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>db.collection.aggregate<span class="token punctuation">(</span><span class="token punctuation">[</span>
  <span class="token punctuation">{</span>
    <span class="token string">"<span class="token variable">$skip</span>"</span><span class="token builtin class-name">:</span> <span class="token number">2</span>,
    
  <span class="token punctuation">}</span>,
  <span class="token punctuation">{</span>
    <span class="token string">"<span class="token variable">$limit</span>"</span><span class="token builtin class-name">:</span> <span class="token number">2</span>,
