<template><div><p>$sample</p>
<ul>
<li>will select a set of random document from collections.</li>
<li>based on number mentioned on size it will return the record.</li>
</ul>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>db.collection.aggregate<span class="token punctuation">(</span><span class="token punctuation">[</span>
  <span class="token punctuation">{</span>
    <span class="token variable">$sample</span><span class="token builtin class-name">:</span> <span class="token punctuation">{</span>
