<template><div><p>$sort</p>
<ul>
<li>( 100mb of ram by default, for allow handling large dataset apply allowDiskUse true).</li>
<li>it will take advantage of indexing if used early in pipeline.</li>
</ul>
