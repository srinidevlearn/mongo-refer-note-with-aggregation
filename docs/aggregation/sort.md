...
lang: en-US
title: $sort
description: $sort in aggregation
pageClass: custom-page-class
previous: './setVsunset.md'
next: './limit.md'
toc: false
---
...
- ( 100mb of ram by default, for allow handling large dataset apply allowDiskUse true).
- it will take advantage of indexing if used early in pipeline.
